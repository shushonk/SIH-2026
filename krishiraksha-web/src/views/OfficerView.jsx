...
export function OfficerView({ activeStoryStep, onStoryActionComplete }) {
  ...
  return (
    <div className="space-y-4 max-w-[1600px] mx-auto pb-12">
      ...
      {/* 4 KPI METRIC BAR (From krishiraksha_geospatial_outbreak_surveillance) */}
      <div className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-4 gap-4">
        ...
        <div className="bg-slate-900/90 border border-slate-800 rounded-2xl p-4 shadow-xl flex flex-col justify-between hover:border-emerald-500/50 transition-all group">
          ...
          <div className="my-2 flex items-baseline justify-between">
            ...
            <svg className="w-20 h-7 text-emerald-400" fill="none" viewBox="0 0 80 28">
              <path d="M0 24 L14 20 L28 22 L42 12 L56 16 L70 6 L80 4" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2.5" />
              <path d="M0 24 L14 20 L28 22 L42 12 L56 16 L70 6 L80 4 L80 28 L0 28 Z" fill="currentColor" fillOpacity="0.1" />
            </svg>
          </div>
        ...
        <div className="bg-slate-900/90 border border-slate-800 rounded-2xl p-4 shadow-xl flex flex-col justify-between hover:border-rose-500/50 transition-all group">
          ...
          <div className="my-2 flex items-baseline justify-between">
            <span className="text-3xl font-black text-rose-400 font-mono tracking-tight">8 Talukas</span>
            <span className="px-2 py-0.5 rounded-md bg-rose-500/10 text-rose-300 text-[10px] font-bold border border-rose-500/20">Zone L-3</span>
          </div>
        ...
        <div className="bg-slate-900/90 border border-slate-800 rounded-2xl p-4 shadow-xl flex flex-col justify-between hover:border-teal-500/50 transition-all group">
          ...
          <div className="my-2 flex items-baseline justify-between">
            <span className="text-3xl font-black text-emerald-400 font-mono tracking-tight">-32.4%</span>
            <span className="text-slate-400 text-xs font-mono">Δ 4,120 kL</span>
          </div>
          <div className="flex items-center gap-1.5 text-slate-400 text-[11px]">
        ...
        <div className="bg-slate-900/90 border border-slate-800 rounded-2xl p-4 shadow-xl flex flex-col justify-between hover:border-amber-500/50 transition-all group">
          ...
          <div className="my-2 flex items-baseline justify-between">
            <span className="text-3xl font-black text-amber-400 font-mono tracking-tight">₹14.2 Cr</span>
            <span className="text-slate-400 text-xs">Avg ₹1,480/acre</span>
          </div>
          <div className="flex items-center gap-1.5 text-slate-400 text-[11px]">
